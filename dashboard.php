...
$mahasiswa = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT COUNT(*) AS total FROM tbl_mahasiswa"));
$guru = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT COUNT(dosen_pengampu) AS total FROM tbl_matkul"));
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Genius Course</span>
                    </div>
                </div>
            </footer>
        </div>
